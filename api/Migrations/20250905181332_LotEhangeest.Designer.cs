...
namespace api.Migrations
{
    ...
    [Migration("20250905181332_LotEhangeest")]
    partial class LotEhangeest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SharedParams.Tables.Lots", b =>
                {
                    ...
                    b.Property<decimal?>("PrixDachatForWhoToWhoIsTrue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SharedParams.Tables.Stocks", b =>
                {
                    ...
                    b.Property<decimal?>("BuyPriceForWhoToWhoIsTrue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SharedParams.Tables.Stocks", b =>
                {
                    ...
                    b.HasOne("SharedParams.Tables.Lots", "LotEchange")
                        .WithMany()
                        .HasForeignKey("LotEchangeId")
                        .OnDelete(DeleteBehavior.Restrict);
